        ...
        <div className="space-y-8 sm:space-y-12">
          {[
            ...
            },
            {
              ...
              description:
                "Automated extraction of structured data from websites for analysis and reporting",
              metrics: {
                performance: 95,
                accessibility: 98,
                seo: 100,
              ...
              techDetails: [
                "Python (BeautifulSoup, Scrapy) for scraping dynamic and static content",
                "Implemented data cleaning and transformation pipelines",
                "Stored extracted data in CSV and Excel databases",
                "Scheduled automated scraping tasks using cron jobs",
            ...
            >
              <div className="grid grid-cols-1 lg:grid-cols-2">
                <div className="p-4 sm:p-6 space-y-4 sm:space-y-6">
                  <h3 className="text-xl sm:text-2xl font-bold text-gray-900 cursor-default select-none">
                    {project.title}
                  </h3>
                  ...
                  <div className="space-y-3">
                    <h4 className="text-base sm:text-lg font-semibold text-gray-900 cursor-default select-none">
                      Performance Metrics
                    </h4>
                    <div className="grid grid-cols-3 gap-2 sm:gap-4">
                      {Object.entries(project.metrics).map(([key, value]) => (
                        <div key={key} className="text-center">
                          <div className="text-2xl font-bold text-blue-600 cursor-default select-none">
                            {value}
                          </div>
                          <div className="text-sm text-gray-600 capitalize cursor-default select-none">
                            {key}
                          </div>
                        </div>
                      ))}
                  ...
                  <div>
                    <h4 className="text-base sm:text-lg font-semibold mb-2 sm:mb-3 text-gray-900 cursor-default select-none">
                      Technical Implementation
                    </h4>
