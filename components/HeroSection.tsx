      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4">
        <div className="text-center space-y-6">
          ...
          <div className="relative inline-block px-4 sm:px-0">
            ...
            <h1 className="relative text-5xl sm:text-7xl md:text-8xl lg:text-9xl font-bold tracking-tight bg-clip-text text-transparent bg-gradient-to-r from-gray-900 to-gray-800 pb-2 cursor-default select-none">
              Shiva Kumar
            </h1>
          </div>
  ...
  Front-End Developer | Building Fast & Modern Web Experiences
            ...
            <div className="flex flex-wrap justify-center gap-2 sm:gap-3 mt-6 sm:mt-8 px-4 sm:px-0">
              {[
                ...
                <span
                  key={tech}
                  className="px-3 sm:px-4 py-1 sm:py-1.5 bg-gray-100 rounded-full text-sm font-medium text-gray-700 border border-gray-200 hover:border-blue-500/50 cursor-pointer select-none transition-transform transform hover:scale-105"
                >
                  {tech}
                </span>
              ))}
      ...
      <div className="absolute bottom-8 inset-x-0 flex flex-col items-center animate-bounce">
        <span className="text-gray-600 text-sm mb-2 text-center cursor-default select-none">
          Scroll to explore
        </span>
        <svg
